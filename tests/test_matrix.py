...
class TestCostMatrixGenerator(unittest.TestCase):
    ...
    def test_matrix_dimensions_and_properties(self):
        ...
        # 1. Distancias (length)
        matrix_dist, nodes_list, paths = generator.generate(self.scenario, weight="length")
        ...
        matrix_time, nodes_list, paths_time = generator.generate(self.scenario, weight="travel_time")
            ...
            for j, v in enumerate(nodes_list):
                ...
                if cost == float("inf"):
                    ...
                    for k in range(len(path) - 1):
                        ...
                        min_len = min(data.get("length", 0.0) for data in edge_data.values())
